...
public class PurchaseController {
    ...
    public Result purchase_findAll_json(@RequestBody PurchaseQuery purchaseQuery){
        return purchaseService.findAll(purchaseQuery);
    }
    ...
    public Result purchase_findAll_Audit(@RequestBody PurchaseQuery purchaseQuery){
        return purchaseService.findAllAudit(purchaseQuery);
    }
    /**
     * 查询所有联系人
     * @return
